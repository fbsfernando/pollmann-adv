/** Status display config para Publicacao (módulo Atualizações). */
export const publicacaoStatusConfig: Record<string, { label: string; className: string }> = {
  PENDENTE: {
    label: "Pendente",
...
export function PublicacaoStatusBadge({ status }: { status: string }) {
  const config = publicacaoStatusConfig[status]
